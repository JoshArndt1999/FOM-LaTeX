...
\section{Tabellen}
Tabellen werden ähnlich wie Abbildungen eingefügt. 
Hinzu kommt jedoch die Syntax, mit welcher die Tabelle als solche (unabhängig vom Float Element) erzeugt wird. 
