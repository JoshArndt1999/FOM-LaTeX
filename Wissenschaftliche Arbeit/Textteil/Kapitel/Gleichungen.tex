...
Um die von der FOM Vorlage\footcite[S. 20]{fomleitfaden} geforderte Unternummerierung von Gleichungen zu erreichen, kann man die \texttt{subequations} Umgebung nutzen. Hier setzt man in die erste Zeile ein Label, auf das dann in den folgenden Zeilen referenziert. Über den \texttt{\textbackslash tag} Befehl wird die Referenz auf das Label eingebaut und die Unternummer manuell vergeben.
