...
\begin{enumerate}
    ...
    \end{enumerate}
\end{enumerate}
Sollen hier die Aufzählungen weiter angepasst werden und zum Beispiel die Zahlen immer arabisch dargestellt werden, so gibt es weitere Quellen, die hierrauf genauer eingehen.\autocite[Vgl.][]{auflistungen}
