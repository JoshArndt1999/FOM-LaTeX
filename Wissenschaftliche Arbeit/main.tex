...
%-------------------------------------------------------------------------------
\documentclass[12pt, a4paper, ngerman,toc=chapterentrydotfill, listof=totoc,bibliography=totoc,captions=figureheading,hidelinks,listof=nochaptergap]{scrreprt} 
...
\printbibliography[type=online,heading=none,title={Internetquellen}]%Literaturverzeichnis der Onlinequellen drucken und ins Inhaltsverzeichnis einfügen 
