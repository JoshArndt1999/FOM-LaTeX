...
\usepackage[a4paper, left=4cm, right=2cm, top=1.5cm, bottom=2cm, headsep=2cm, includehead=true, footskip=0cm, includefoot=true, headheight = 0.5cm]{geometry} 
...
\usepackage[backend=biber, style=ext-authoryear, isbn=false, maxcitenames=2, maxbibnames=999, mergedate=false, innamebeforetitle, dashed=false, autocite=footnote, mincrossrefs=1, autopunct=false]{biblatex}%Bibliotheksverwaltung (siehe goLatex FOM)
