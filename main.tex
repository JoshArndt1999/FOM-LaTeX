\documentclass[12pt, a4paper, ngerman,toc=chapterentrydotfill, listof=totoc,bibliography=totoc,captions=figureheading, 
   captions=nooneline]{scrreprt} 
...
\usepackage[labelfont=bf,position=top, skip = 6pt]{caption}
